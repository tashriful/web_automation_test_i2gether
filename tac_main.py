...
from tac_functions import lst_output_status_check

excel_file_location = f'C:/Users/123/Downloads/Tac Define/tac.xlsx'
result_file_location = f'E:/Robi RPA/Tac Define/'
...
# if not a:
#     print("undefined")
stat = lst_output_status_check(result_file_location,result_file_name)
print(stat)
