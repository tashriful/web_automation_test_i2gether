...
loc = f'C:/Users/RPA/Downloads/Robi RPA/Short Code Define/'
file = f'vmsc.rst'
...
# print(add_mail_body)
add_mail_body = prepare_add_mail_body(mail_header_data, "ok", "yes", plan_mail_data, lst_mail_body, add_mail_body, "successful", "accept")
print(add_mail_body)
